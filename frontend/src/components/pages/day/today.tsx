...
export const GoodMorning: Component = () => {
  ...
  const alarms = createMemo(() => dayContext()?.alarms || []);
    ...
    <Page>
      <div class="flex flex-col min-h-full px-4 py-6">
        ...
        <div class="text-center mb-8">
          <h1 class="text-2xl font-light text-gray-900 mb-1">Good Morning</h1>
        ...
        <div class="flex-1">
          <Show when={!hasHighlights()}>
            <div class="text-center py-8 text-gray-400">
              <p class="text-sm">A quiet, routine day ahead.</p>
            </div>
          </Show>
        ...
        <div class="mt-auto pt-6">
          <button
            ...
            class="w-full py-3 bg-gray-900 text-white text-sm uppercase tracking-widest rounded-lg hover:bg-gray-800 transition-colors"
          >
            Start Day
          </button>
        </div>
