  ...
  return (
    <>
      <SEO
        ...
        description="By using lykke.day, you agree to these terms. We provide a daily planning and wellness companion—use it kindly and lawfully."
        path="/terms"
      />
        ...
        <div class="max-w-2xl mx-auto px-6 py-16 flex-1">
          ...
          <div class="space-y-8 text-stone-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Everything you create in lykke.day belongs to you. We don't
                claim ownership of your tasks, plans, or any content you add.
                You grant us permission to store and display your content back
                to you — nothing more.
              </p>
            </section>
