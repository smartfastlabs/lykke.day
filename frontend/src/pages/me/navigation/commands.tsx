...
import { faRotate, faCheck, faExclamationTriangle } from "@fortawesome/free-solid-svg-icons";
...
const CommandsPage: Component = () => {
  ...
  const handleRescheduleToday = async () => {
    if (!confirm("This will delete all tasks and audit logs for today and create fresh tasks from your routines. Continue?")) {
      return;
    }
    ...
    try {
      ...
      setMessage({ type: 'success', text: "Successfully rescheduled today! All tasks have been recreated from your routines." });
      ...
      setMessage({ type: 'error', text: "Failed to reschedule today. Please try again." });
    } finally {
              ...
              <Show when={message()}>
                {(msg) => (
                  <div
                    ...
                    classList={{
                      "bg-green-50 border border-green-200": msg().type === 'success',
                  ...
                  >
                    ...
                    >
                      <path d={(msg().type === 'success' ? faCheck : faExclamationTriangle).icon[4] as string} />
                    </svg>
                    <p
                      class="text-sm"
                      classList={{
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-amber-800 text-sm">
                Rescheduling will permanently delete all tasks and audit logs for the selected date. 
                This action cannot be undone. Make sure this is what you want before proceeding.
              </p>
            </div>
          </div>
        </div>
