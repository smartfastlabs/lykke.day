...
const Resources: Component = () => {
  ...
  const mounted = usePageAnimation("resources");
      ...
      <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col items-center px-6 py-20 md:py-28">
          <div class="max-w-3xl w-full text-center">
            ...
            >
              <Quote quote="True wisdom isn't found in the destination—it's gathered in the quiet practice of showing up, day after day." />
            </div>
