...
This project is also an experiment in building software with LLMs (Large Language Models). The codebase is **heavily reliant on AI assistance** — we have chosen a DDD architecture but LLMs do 90% of the implementation.
