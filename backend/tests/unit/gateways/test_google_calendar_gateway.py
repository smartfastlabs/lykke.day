...
def test_parse_event_timestamp_valid_z() -> None:
    ...
    result = GoogleCalendarGateway._parse_event_timestamp("2026-02-02T08:15:37.614Z")
...
def test_parse_event_timestamp_naive_assumes_utc() -> None:
    ...
    result = GoogleCalendarGateway._parse_event_timestamp("2026-02-02T08:15:37.614")
