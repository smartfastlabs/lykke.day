...
def test_record_action_status_transitions(
    ...
    action = entities.Action(type=action_type)
...
def test_mark_pending_already_pending(test_task: entities.Task) -> None:
...
def test_mark_ready(test_task: entities.Task) -> None:
...
def test_mark_ready_already_ready(test_task: entities.Task) -> None:
