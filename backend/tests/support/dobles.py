...
def create_read_only_repos_double(
    *,
    ...
    user_profile_repo: InstanceDouble | None = None,
) -> InstanceDouble:
    ...
    repos_double.bot_personality_ro_repo = bot_personality_repo or create_repo_double(
        BotPersonalityRepositoryReadOnlyProtocol
    )
    repos_double.brain_dump_ro_repo = brain_dump_repo or create_repo_double(
        BrainDumpRepositoryReadOnlyProtocol
    )
    repos_double.calendar_entry_ro_repo = calendar_entry_repo or create_repo_double(
        CalendarEntryRepositoryReadOnlyProtocol
    )
    ...
    repos_double.calendar_ro_repo = calendar_repo or create_repo_double(
        CalendarRepositoryReadOnlyProtocol
    )
    repos_double.day_ro_repo = day_repo or create_repo_double(
        DayRepositoryReadOnlyProtocol
    )
    repos_double.day_template_ro_repo = day_template_repo or create_repo_double(
        DayTemplateRepositoryReadOnlyProtocol
    )
    repos_double.factoid_ro_repo = factoid_repo or create_repo_double(
        FactoidRepositoryReadOnlyProtocol
    )
    repos_double.message_ro_repo = message_repo or create_repo_double(
        MessageRepositoryReadOnlyProtocol
    )
    ...
    repos_double.routine_ro_repo = routine_repo or create_repo_double(
        RoutineRepositoryReadOnlyProtocol
    )
    ...
    repos_double.tactic_ro_repo = tactic_repo or create_repo_double(
        TacticRepositoryReadOnlyProtocol
    )
    repos_double.task_definition_ro_repo = task_definition_repo or create_repo_double(
        TaskDefinitionRepositoryReadOnlyProtocol
    )
    repos_double.task_ro_repo = task_repo or create_repo_double(
        TaskRepositoryReadOnlyProtocol
    )
    ...
    repos_double.trigger_ro_repo = trigger_repo or create_repo_double(
        TriggerRepositoryReadOnlyProtocol
    )
    repos_double.usecase_config_ro_repo = usecase_config_repo or create_repo_double(
        UseCaseConfigRepositoryReadOnlyProtocol
    )
    repos_double.user_profile_ro_repo = user_profile_repo or create_repo_double(
        UserProfileRepositoryReadOnlyProtocol
    )
    return repos_double
...
def create_uow_double(
    *,
    ...
    uow_double.bot_personality_ro_repo = bot_personality_repo or create_repo_double(
        BotPersonalityRepositoryReadOnlyProtocol
    )
    uow_double.brain_dump_ro_repo = brain_dump_repo or create_repo_double(
        BrainDumpRepositoryReadOnlyProtocol
    )
    uow_double.calendar_entry_ro_repo = calendar_entry_repo or create_repo_double(
        CalendarEntryRepositoryReadOnlyProtocol
    )
    ...
    uow_double.calendar_ro_repo = calendar_repo or create_repo_double(
        CalendarRepositoryReadOnlyProtocol
    )
    uow_double.day_ro_repo = day_repo or create_repo_double(
        DayRepositoryReadOnlyProtocol
    )
    uow_double.day_template_ro_repo = day_template_repo or create_repo_double(
        DayTemplateRepositoryReadOnlyProtocol
    )
    uow_double.factoid_ro_repo = factoid_repo or create_repo_double(
        FactoidRepositoryReadOnlyProtocol
    )
    uow_double.message_ro_repo = message_repo or create_repo_double(
        MessageRepositoryReadOnlyProtocol
    )
    uow_double.push_notification_ro_repo = push_notification_repo or create_repo_double(
        PushNotificationRepositoryReadOnlyProtocol
    )
    uow_double.push_subscription_ro_repo = push_subscription_repo or create_repo_double(
        PushSubscriptionRepositoryReadOnlyProtocol
    )
    uow_double.routine_ro_repo = routine_repo or create_repo_double(
        RoutineRepositoryReadOnlyProtocol
    )
    ...
    uow_double.tactic_ro_repo = tactic_repo or create_repo_double(
        TacticRepositoryReadOnlyProtocol
    )
    uow_double.task_definition_ro_repo = task_definition_repo or create_repo_double(
        TaskDefinitionRepositoryReadOnlyProtocol
    )
    uow_double.task_ro_repo = task_repo or create_repo_double(
        TaskRepositoryReadOnlyProtocol
    )
    ...
    uow_double.trigger_ro_repo = trigger_repo or create_repo_double(
        TriggerRepositoryReadOnlyProtocol
    )
    uow_double.usecase_config_ro_repo = usecase_config_repo or create_repo_double(
        UseCaseConfigRepositoryReadOnlyProtocol
    )
    uow_double.user_profile_ro_repo = user_profile_repo or create_repo_double(
        UserProfileRepositoryReadOnlyProtocol
    )
