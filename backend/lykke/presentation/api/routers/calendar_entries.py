...
async def create_calendar_entry(
    ...
    handler: Annotated[
        CreateCalendarEntryHandler,
        Depends(create_command_handler(CreateCalendarEntryHandler)),
    ],
) -> CalendarEntrySchema:
...
async def delete_calendar_entry(
    ...
    handler: Annotated[
        DeleteCalendarEntryHandler,
        Depends(create_command_handler(DeleteCalendarEntryHandler)),
    ],
) -> None:
    """Delete a calendar entry (user-scoped)."""
    await handler.handle(DeleteCalendarEntryCommand(calendar_entry_id=uuid))
...
async def update_calendar_entry(
    ...
    handler: Annotated[
        UpdateCalendarEntryHandler,
        Depends(create_command_handler(UpdateCalendarEntryHandler)),
    ],
) -> CalendarEntrySchema:
