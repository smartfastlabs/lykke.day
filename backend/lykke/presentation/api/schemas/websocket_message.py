...
class WebSocketSyncRequestSchema(BaseSchema):
    ...
    since_timestamp: str | None = None  # ISO format datetime - if provided, only return changes since this time
...
class EntityChangeSchema(BaseSchema):
    ...
    entity_id: UUID
    entity_data: dict[str, Any] | None  # Full entity data for created/updated, None for deleted
