...
class DayTemplateRepositoryReadOnlyProtocol(
    ReadOnlyRepositoryProtocol[DayTemplateEntity], Protocol
):
...
class DayTemplateRepositoryReadWriteProtocol(
    ReadWriteRepositoryProtocol[DayTemplateEntity], Protocol
):
