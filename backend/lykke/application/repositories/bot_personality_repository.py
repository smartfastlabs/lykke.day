...
class BotPersonalityRepositoryReadOnlyProtocol(
    ReadOnlyRepositoryProtocol[BotPersonalityEntity]
):
...
class BotPersonalityRepositoryReadWriteProtocol(
    ReadWriteRepositoryProtocol[BotPersonalityEntity]
):
