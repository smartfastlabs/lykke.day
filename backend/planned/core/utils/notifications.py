...
from planned.domain.entities import CalendarEntryEntity, TaskEntity


def build_notification_payload_for_tasks(tasks: list[TaskEntity]) -> value_objects.NotificationPayload:
